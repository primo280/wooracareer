  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-emerald-50">
     ...
     {/* <FeaturedCompanies /> */}
      ...
      <a
        href="https://wa.me/1234567890?text=Bonjour,%20j'aimerais%20en%20savoir%20plus%20sur%20vos%20services"
        target="_blank"
      ...
      >
        <Button
          size="lg"
          className="rounded-full w-14 h-14 bg-green-500 hover:bg-green-600 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 p-0"
        >
          <svg
            className="w-6 h-6"
            fill="currentColor"
